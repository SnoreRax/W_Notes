...
12. When obfuscating strings, instead of turnign the string into `charCode()` or encoding it in `base64`, you can (most of the time) use the `eval()` function to split the string instead, like this: `eval('imp'+'ort()')`
